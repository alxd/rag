...
def real_llm_grouping(concepts, prompt, model, output_dir=None):
    ...
    try:
        if "gpt" in model.lower() or "o1-mini" in model.lower() or "o3-mini" in model.lower():
            ...
            model_name = model_map.get(model.lower(), "gpt-3.5-turbo")
            ...
            response = model_gemini.generate_content(prompt_full)
            ...
            print("[LLM GROUPING REAL] Grok model not yet implemented (no public API).")
            raise RuntimeError("Grok model not yet implemented (no public API).")
        elif "qwen3" in model.lower():
            print("[LLM GROUPING REAL] Qwen3 model not yet implemented (no public API).")
            raise RuntimeError("Qwen3 model not yet implemented (no public API).")
